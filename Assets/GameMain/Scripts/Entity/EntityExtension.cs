...
namespace SG1
{
    public static class EntityExtension
    {
        ...
        public static void ShowIronWall(this EntityComponent entityComponent, WallData data)
        {
            entityComponent.ShowEntity(typeof(IronWall), "Wall", 2, data);
        }
        public static void ShowWoodWall(this EntityComponent entityComponent, WallData data)
        {
            entityComponent.ShowEntity(typeof(WoodWall), "Wall", 1, data);
        }   
        public static void ShowPlayer(this EntityComponent entityComponent, PlayerData data)
        {
            entityComponent.ShowEntity(typeof(Player), "Player", 1, data);
        }
        
        public static void ShowBomb(this EntityComponent entityComponent, BombData data)
        {
            entityComponent.ShowEntity(typeof(Bomb), "Bomb", 1, data);
        }
        public static void Showfire(this EntityComponent entityComponent, fireData data)
        {
            entityComponent.ShowEntity(typeof(fire), "fire", 1, data);
        }
        public static void ShowEnemy(this EntityComponent entityComponent, EnemyData data)
        {
            entityComponent.ShowEntity(typeof(Enemy), "Enemy", 1, data);
        }
